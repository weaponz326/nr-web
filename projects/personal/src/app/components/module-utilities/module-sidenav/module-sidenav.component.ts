...
export class ModuleSidenavComponent implements OnInit {
  ...
  checkConfigAccess(e: any){
    ...
    if(this.suite == 'Personal')
      ...
      this.accessLevel = JSON.parse(localStorage.getItem('restaurantUserAccess') as string).access_level;
    else if(this.suite == 'School')
      this.accessLevel = JSON.parse(localStorage.getItem('schoolUserAccess') as string).access_level;
    else if(this.suite == 'Association')
      this.accessLevel = JSON.parse(localStorage.getItem('associationUserAccess') as string).access_level;
    else if(this.suite == 'Enterprise')
      this.accessLevel = JSON.parse(localStorage.getItem('enterpriseUserAccess') as string).access_level;
    else if(this.suite == 'Hotel')
      this.accessLevel = JSON.parse(localStorage.getItem('hotelUserAccess') as string).access_level;
    else if(this.suite == 'Hospital')
      this.accessLevel = JSON.parse(localStorage.getItem('hospitalUserAccess') as string).access_level;
    else if(this.suite == 'Shop')
      this.accessLevel = JSON.parse(localStorage.getItem('shopUserAccess') as string).access_level;
    else if(this.suite == 'Production')
      this.accessLevel = JSON.parse(localStorage.getItem('productionUserAccess') as string).access_level;
