...
import { Invitation } from 'projects/shop/src/app/models/modules/admin/admin.model';
...
export class UserSearchComponent implements OnInit {
  ...
  getSearchDetail(){
    this.authApi.getSearchDetail(String(sessionStorage.getItem('shopAdminSearchUser')))
      .subscribe({
        next: (res) => {
          console.log(res);
