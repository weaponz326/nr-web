...
export class AccountApiService {
  ...
  accountUrl = environment.apiUrl + 'shop-accounts/';
  ...
  public putAccount(account: any): Observable<any>{
    return this.http.put(this.accountUrl + "account/" + this.customCookie.getCookie('shop_id'), account, this.authHeaders.headers);
  }

  public patchAccount(account: any): Observable<any>{
    return this.http.patch(this.accountUrl + "account/" + this.customCookie.getCookie('shop_id'), account, this.authHeaders.headers);
  }

  public getAccount(): Observable<any>{
    return this.http.get(this.accountUrl + "account/" + this.customCookie.getCookie('shop_id'), this.authHeaders.headers);
  }

  public putLogo(logo: File) {
    let formParams = new FormData();
    formParams.append('logo', logo);
    return this.http.put(this.accountUrl + "account/" + this.customCookie.getCookie('shop_id'), formParams, this.authHeaders.headers)
  }
  ...
  public getSearchResults(input: string, page: any, size: any): Observable<any>{
    return this.http.get(this.accountUrl + "search-list?account=" + this.customCookie.getCookie('shop_id') 
      + "&search=" + input
      + "&page=" + page
      + "&size=" + size,
