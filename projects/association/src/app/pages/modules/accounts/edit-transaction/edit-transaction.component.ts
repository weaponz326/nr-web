...
// import { Transaction } from 'projects/association/src/app/models/modules/accounts/accounts.model';
...
export class EditTransactionComponent implements OnInit {
  ...
  saveTransaction(){
    ...
    let data = {
      ...
      account: sessionStorage.getItem('association_account_id') as string,
    }
