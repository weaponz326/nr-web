...
export class AttendanceApiService {
  ...
  attendanceUrl = environment.apiUrl + 'association-modules/attendance/';

  // attendance

  public getAccountAttendance(page: any, size: any, sortField: any): Observable<any>{
    return this.http.get(this.attendanceUrl + "attendance?account=" + this.customCookie.getCookie('association_id')
      + "&page=" + page
      + "&size=" + size
  ...
  public getAttendance(): Observable<any>{
    return this.http.get(this.attendanceUrl + "attendance/" + sessionStorage.getItem('association_attendance_id'), this.authHeaders.headers);
  }

  public putAttendance(attendance: any): Observable<any>{
    return this.http.put(this.attendanceUrl + "attendance/" + sessionStorage.getItem('association_attendance_id'), attendance, this.authHeaders.headers);
  }
