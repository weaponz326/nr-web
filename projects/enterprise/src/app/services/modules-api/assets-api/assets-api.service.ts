...
export class AssetsApiService {
  ...
  public getAssetCodeConfig(): Observable<any>{
    return this.http.get(this.assetsUrl + "config/asset-code/" + this.customCookie.getCookie('enterprise_id'), this.authHeaders.headers);
  }

  public putAssetCodeConfig(asset: any): Observable<any>{
    return this.http.put(this.assetsUrl + "config/asset-code/" + this.customCookie.getCookie('enterprise_id'), asset, this.authHeaders.headers);
  }

  public getNewAssetCodeConfig(): Observable<any>{
    return this.http.get(this.assetsUrl + "config/new-asset-code/" + this.customCookie.getCookie('enterprise_id'), this.authHeaders.headers);
  }
