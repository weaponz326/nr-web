...
export class ConfigurationComponent implements OnInit {
  ...
  navHeading: any[] = [
    { text: "Configuration", url: "/home/procurement/configuration" },
  ];
  ...
  putProcurementCodeConfig(){
    ...
    this.procurementApi.putProcurementCodeConfig(data)
      .subscribe({
        next: (res) => {
          console.log(res);
