...
import { CustomerCodeConfig } from 'projects/restaurant/src/app/models/modules/customers/customers.model';
...
export class ConfigurationComponent implements OnInit {
  ...
  navHeading: any[] = [
    { text: "Configuration", url: "/home/customers/configuration" },
  ];
  ...
  putCustomerCodeConfig(){
    let data: CustomerCodeConfig = {
    ...
    this.customersApi.putCustomerCodeConfig(data)
      .subscribe({
        next: (res) => {
          console.log(res);
