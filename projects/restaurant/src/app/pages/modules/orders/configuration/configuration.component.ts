...
import { OrderCodeConfig } from 'projects/restaurant/src/app/models/modules/orders/orders.model';
...
export class ConfigurationComponent implements OnInit {
  ...
  navHeading: any[] = [
    { text: "Configuration", url: "/home/orders/configuration" },
  ];
  ...
  putOrderCodeConfig(){
    ...
    this.ordersApi.putOrderCodeConfig(data)
      .subscribe({
        next: (res) => {
          console.log(res);
