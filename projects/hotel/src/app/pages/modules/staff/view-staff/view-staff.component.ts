...
// import { StaffPrintService } from 'projects/hotel/src/app/services/modules-printing/staff-print/staff-print.service';
...
export class ViewStaffComponent implements OnInit {
  ...
  storageBasePath = "/hotel/" + this.customCookie.getCookie('hotel_id') + "/module_staff/";
